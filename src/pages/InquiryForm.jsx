                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 transition-colors ${errors.contactNumber ? "border-red-500" : "border-gray-300"}`}
                      ...
                      {["Yes", "No"].map(o => (
                        <label key={o} className="flex items-center space-x-3 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-500 cursor-pointer">
                          <input
                            ...
                            name="apsCertificate"
                            value={o}
                            checked={formData.apsCertificate === o}
                            onChange={handleChange}
                            className="text-blue-600 focus:ring-blue-500"
                          />
                          <span>{o}</span>
                      ...
                      {["Summer", "Winter"].map(o => (
                        <label key={o} className="flex items-center space-x-3 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-500 cursor-pointer">
                          <input
                            ...
                            name="targetIntake"
                            value={o}
                            checked={formData.targetIntake === o}
                            onChange={handleChange}
                            className="text-blue-600 focus:ring-blue-500"
                          />
                          <span>{o}</span>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 ${errors.source ? "border-red-500" : "border-gray-300"}`}
                    >
