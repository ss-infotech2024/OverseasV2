    ...
    return (
        <div className="min-h-screen bg-white pt-12 sm:pt-16 lg:pt-20">
            ...
            <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6 text-center">
                <div className="inline-flex items-center bg-teal-600 text-white text-xs font-semibold px-3 py-1 rounded-full mb-3 text-[10px] sm:text-xs shadow-md">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-teal-600 via-emerald-600 to-orange-600 bg-clip-text text-transparent leading-tight drop-shadow-sm">
                    Campus Life Gallery
                </h1>
                <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-800 max-w-xl mx-auto px-2 font-medium">
                    Discover a world-class education with students from <span className="font-bold text-teal-600">over 50+ countries</span>.
                </p>
            </header>
