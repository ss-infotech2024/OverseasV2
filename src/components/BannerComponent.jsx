  ...
  return (
    <div className="bg-blue-900 text-white p-6 md:p-9 rounded-lg shadow-lg flex flex-col md:flex-row items-center justify-between w-[95%] max-w-7xl mx-auto gap-6 mt-14"> {/* Added mt-8 for top margin */}
      ...
      <div className="flex md:flex-col space-x-4 md:space-x-0 md:space-y-4 order-1 md:order-1">
        ...
        <a href="#" className="text-white hover:text-gray-300 transition-colors">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            <path d="M23.643 4.937c-.835.37-1.732.62-2.675.733.962-.576 1.7-1.49 2.048-2.578-.9.534-1.897.922-2.958 1.13-.85-.904-2.06-1.47-3.4-1.47-2.572 0-4.658 2.086-4.658 4.66 0 .364.042.718.12 1.06-3.873-.194-7.304-2.05-9.602-4.868-.4.69-.63 1.49-.63 2.342 0 1.616.823 3.043 2.072 3.878-.764-.025-1.482-.234-2.11-.584v.06c0 2.257 1.605 4.14 3.737 4.568-.392.106-.803.162-1.227.162-.3 0-.593-.028-.877-.082.593 1.85 2.313 3.198 4.352 3.234-1.595 1.25-3.604 1.995-5.786 1.995-.376 0-.747-.022-1.112-.065 2.062 1.323 4.51 2.093 7.14 2.093 8.57 0 13.255-7.098 13.255-13.254 0-.2-.005-.402-.014-.602.9-.656 1.683-1.473 2.3-2.408z"/>
          </svg>
        </a>
      </div>
      ...
      <div className="text-center md:text-left flex-1 order-3 md:order-2">
        ...
        <button className="mt-6 px-6 py-2 bg-white text-blue-900 rounded-full hover:bg-gray-200 transition-colors font-medium">
          Contact Us
        </button>
      </div>
